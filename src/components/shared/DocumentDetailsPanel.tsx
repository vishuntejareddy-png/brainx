  ...
  return (
    <div className="w-96 shrink-0 border-l border-border-hair bg-bg-card-2 p-8 overflow-y-auto">
      <div className="flex items-start justify-between mb-2">
        ...
        <button onClick={onClose} className="text-zinc-500 hover:text-text-primary">
          <X size={18} />
        </button>
      </div>
      ...
      <div className="mt-8 flex gap-2">
        <button className="flex-1 bg-mint text-black text-btn font-semibold rounded-lg py-2.5 hover:opacity-90 transition-opacity">
          Open Full Document
        </button>
      </div>
      <div className="mt-2 flex gap-2">
        <button className="flex-1 text-btn px-4 py-2.5 rounded-lg border border-border-hair text-zinc-300 hover:bg-white/[0.02] transition-colors">
          Ask Copilot
        </button>
        <button className="flex-1 text-btn px-4 py-2.5 rounded-lg border border-border-hair text-zinc-300 hover:bg-white/[0.02] transition-colors">
          Download
